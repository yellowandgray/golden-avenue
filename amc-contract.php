...
<!--            <section id="content-1" style="background:#eae8e8;">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 text-justify">
                            ...
                            <p>Golden Avenue is based out of UAE & expanding its services across Middle East. With the vision of helping small businesses in Middle East by using MSP technology to effectively grow, manage and protect IT Information Assets, our team of experts will dedicatedly assist you in maintaining your IT Systems, Network Infrastructure, Servers, & Storage Systems etc.</p>
                        </div>
                        <div class="col-md-5">
            ...
            <div style="width: 100%;">
                <div class="container content">
                    ...
                    <div class="col-md-8 bx2-5">
                        <h4 class="color-blue">Data Management</h4>
            ...
            <section id="content" style="padding: 0px">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3>We sustain you in Crisis Hour</h3>
                            ...
                            <h3>Confidentiality and Work Ethics</h3>
                            <p class="text-justify">We respect your confidential and private information, know how important confidentiality is to you, whether it’s business or personal data, or both. Our tech experts have the training and the tools necessary to protect and secure your professionally sensitive and private data.</p>
                        </div>
                    </div>
                </div>
            </section>
