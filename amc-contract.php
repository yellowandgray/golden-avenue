<!DOCTYPE html>
<html lang="en">
    <?php $page = 'amc-contract'; include 'head.php'; ?>
    <body>
        <div id="wrapper">
                        ...
                        <section class="section-padding">
                            <div class="row table-center-align">
                                ...
                                <table class="table">
                                    <tr>
                                        <th></th>
                                        <td class="bold gray font-size-20">BASIC</td>
                                        <td class="bold orange font-size-20">STANDARD</td>
                                        <td class="bold blue font-size-20">ENTERPRISE</td>
                                    </tr>
                                    <tr>
