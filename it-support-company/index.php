                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 wow fadeInUp">
                            <div class="cyber-security-bg1">
                                <img src="images/it-security.jpg" alt="" class="img-responsive" />
                            </div>
                        </div>
                    </div>
                </div>
            </section>
            <section id="banner" style="background: #fff;">
                <section class="section-padding">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 wow fadeInUp">
                                <div class="b1">
                                    <h3 class="color-white bold font-size-29"><span class="font-size-56">Cloud Migration Services</span><br/></h3>
                                </div>
                            </div>
                            <div class="col-md-4 wow fadeInUp">
                                <div class="b2">
                                    <h3 class="blue-color bold">Software as a Service (Saas)</h3>
                            ...
                            <div class="col-md-4 wow fadeInUp">
                                <div class="b3">
                                    <h3 class="blue-color bold">Infrastructure as a Service (Iaas)</h3>
...
<!--                                    <img src="img/sub-banner/amc-3-4.png" alt=""/>-->
            ...
            <section class="section-padding custome-gray-bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="color-white text-center">Why Golden Avenue?</h2>
                        </div>
                        <div class="col-md-4 wow fadeInUp">
                        ...
                        <div class="col-md-4 wow fadeInUp">
                            <div class="landing-box">
                                <h3>Competent and Resourceful</h3>
                                <p class="text-justify">We adapt to the convenience of our clients to provide them the best IT assistance. We offer multiple options and contracts that help them decide on best possible service needed for their business at a minimal cost. <br/><br/><br/></p>
                            </div>
                        </div>
                        <div class="col-md-4 wow fadeInUp">
                            <div class="landing-box">
