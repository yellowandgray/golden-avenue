                ...
                <div class="container">
                    ...
                    <div class="row" style="background: url(img/why-us-background.jpg) no-repeat;padding: 40px;background-size: cover;">
                        <div class="about">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="bold text-justify margin-right-9">A visionary business leader, driving high-tech innovations into a successful business. Under his leadership Golden Avenue is dedicated to achieving success and making a lasting impact on their clientèle.</p> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="about">
                            ...
                            <div class="col-md-4 wow fadeInUp">
                                <div class="why-us-content">
                                    <h3>High Integrity and Ethical Standards</h3>
                                    <p class="text-justify">We are not driven by money but respect. Our most valuable asset are our Clients and the repute we earn from them. <br/><br/><br/><br/></p>
                                </div>
                            </div>
                            <div class="col-md-4 wow fadeInUp">
                                <div class="why-us-content">
                                    <h3>Flexible Contracts</h3>
                                    <p class="text-justify">Our Clients benefit monetarily through a better financial budgeted Plan due to our fixed managed service packages & flexible Annual Maintenance contracts. <br/><br/><br/><br/></p>
                                </div>
                            </div>
                        </div>
                    </div>
