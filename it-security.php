                    ...
                    <div class="container">
                        ...
                        <div class="row showcase-section">
                            <div class="col-md-7">
                                ...
                                <h3 class="bold color-blue">Make IT security your top business priority</h3>
                                <p class="text-justify">When companies move their business processes towards mobility, collaboration or the cloud, progressing without IT security is unthinkable.</p>
                                ...
                                <p class="text-justify">Golden Avenue ensures to give you full control over your virtual, physical and cloud IT environments. Our team brings to you tailormade solutions for your IT infrastructure that is scalable, flexible and threat free. Our solutions will add wings of freedom to drive your business growth.</p>
                            ...
                            <div class="col-md-5 wow fadeInRight" data-wow-delay="1.5s">
                                ...
                                <div class="box-shadow-cyber-attack text-center margin-t-b-20">
                                    ...
                                    <h2><span class="out-of-font color-blue">9</span> OUT OF <span class="out-of-font color-blue">10</span></h2>
                                    ...
                                    <button class="btn"><a href="#"><span class="font-size-22 bold color-white">LEARN MORE</span><p class="font-size-12 color-white margin-t-b-0">FROM OUR CYBER SECURITY WORKSHOP</p></a></button>
                                </div>
                                <br/>
