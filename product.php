...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Enterprise Computing & Telecom, Laptops, Desktops, Servers, Printers, Networking and Security products, top-tier brands and ensure genuine products, most trusted in Dubai" />
    ...
    <body>
        <div id="wrapper">
            ...
            <!-- end header -->
            <section id="inner-headline-11" class="wow fadeInUp">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
