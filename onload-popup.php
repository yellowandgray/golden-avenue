    ...
    <div class="modal-dialog">
        ...
        <div class="modal-onload-content">
            <div class="modal-header-1">
                ...
                <h3 class="text-center margin-top-10">Join us for a live demo</h3>
                <p class="text-center line-height-25">We will walk you through the product suite and answer any questions you have about FirstBIT ERP</p>
