...
if ($_POST['name']) {
    ...
    $mail->Host = "yellowandgray.com";      // sets GMAIL as the SMTP server
    ...
    $mail->Subject = "Contact Form" . date('d-m-y H:i:s');
    $message = '<table border = "0" cellpadding = "0" cellspacing = "0" height = "100%" width = "100%">
            ...
            <p style = "margin:0 0 16px">Comment :' . $comments . '</p>
    ...
    $mail->AddAddress($address, "Golden Avenue");
    //$mail->AddCC('npschoolkkl@gmail.com', 'Golden Avenue');
